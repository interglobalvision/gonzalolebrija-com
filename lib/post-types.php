...
function post_type_exposiciones() {
...
function post_type_obra() {
	...
	$labels = array(
		...
		'archives'              => __( 'Obras Archives', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Obra', 'text_domain' ),
		'description'           => __( 'Obras', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', ),
...
function post_type_journal() {
	...
	$labels = array(
		...
		'archives'              => __( 'Journal Archives', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
...
add_action( 'init', 'post_type_journal', 0 );

// Register Custom Post Type
function post_type_publicaciones() {
...
add_action( 'init', 'post_type_publicaciones', 0 );
